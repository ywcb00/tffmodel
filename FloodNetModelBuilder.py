...
class FloodNetModelBuilder(IKerasModelBuilder):
    ...
    def buildKerasModelLayers(self, model):
        ...
        match self.model_abbrv:
            case "c10_avg_dr25":
                ...
                model.add(tf.keras.layers.Conv2D(10, 10, strides=5, padding="same",
                ...
                model.add(tf.keras.layers.Dropout(0.25, seed=self.config["seed"]))
                model.add(tf.keras.layers.Dense(1, activation=tf.keras.activations.sigmoid,
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
            case "c20_c10_avg_dr25":
                # first layer is the input
                model.add(tf.keras.layers.Conv2D(20, 10, strides=10, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.BatchNormalization(
                    beta_initializer=tf.keras.initializers.Zeros(),
                    ...
                    moving_variance_initializer=tf.keras.initializers.Ones()))
                model.add(tf.keras.layers.Activation("relu"))
                model.add(tf.keras.layers.Conv2D(10, 8, strides=10, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.BatchNormalization(
                    beta_initializer=tf.keras.initializers.Zeros(),
            ...
            case "c40_c20_c10_avg_dr25":
                # first layer is the input
                model.add(tf.keras.layers.Conv2D(40, 10, strides=5, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.BatchNormalization(
                    beta_initializer=tf.keras.initializers.Zeros(),
            ...
            case "c32_c64_c16_avg_fl_dr50":
                # first layer is the input
                model.add(tf.keras.layers.Conv2D(32, (11, 11), strides=2, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.BatchNormalization(
                    beta_initializer=tf.keras.initializers.Zeros(),
                ...
                model.add(tf.keras.layers.Conv2D(64, (11, 11), strides=3, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.BatchNormalization(
                    beta_initializer=tf.keras.initializers.Zeros(),
                ...
                model.add(tf.keras.layers.Activation("relu"))
                model.add(tf.keras.layers.MaxPool2D((3, 3)))
                model.add(tf.keras.layers.Conv2D(16, (11, 11), strides=3, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.BatchNormalization(
                    beta_initializer=tf.keras.initializers.Zeros(),
            ...
            case "c64_c32_avg_dr50_dr25":
                # first layer is the input
                model.add(tf.keras.layers.Conv2D(64, (5, 5), strides=3, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                ...
                model.add(tf.keras.layers.Activation("relu"))
                model.add(tf.keras.layers.MaxPool2D((3, 3)))
                model.add(tf.keras.layers.Conv2D(32, (5, 5), strides=3, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.GroupNormalization(groups=16,
                    beta_initializer=tf.keras.initializers.Zeros(),
            ...
            case "c64_c32_c32_avg_dr50_dr25":
                # first layer is the input
                model.add(tf.keras.layers.Conv2D(64, (11, 11), strides=7, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.GroupNormalization(groups=16,
                    beta_initializer=tf.keras.initializers.Zeros(),
                ...
                model.add(tf.keras.layers.Activation("relu"))
                model.add(tf.keras.layers.MaxPool2D((3, 3)))
                model.add(tf.keras.layers.Conv2D(32, (7, 7), strides=3, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.GroupNormalization(groups=16,
                    beta_initializer=tf.keras.initializers.Zeros(),
            ...
            case "c96_c64_c32_avg_dr50_dr25":
                # first layer is the input
                model.add(tf.keras.layers.Conv2D(96, (11, 11), strides=3, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.GroupNormalization(groups=16,
                    beta_initializer=tf.keras.initializers.Zeros(),
            ...
            case "c96_c32_dr25_dr50":
                # first layer is the input
                model.add(tf.keras.layers.Conv2D(96, (17, 17), strides=5, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
                model.add(tf.keras.layers.GroupNormalization(groups=16,
                    beta_initializer=tf.keras.initializers.Zeros(),
                ...
                model.add(tf.keras.layers.Conv2D(32, (11, 11), strides=3, padding="same",
                    kernel_initializer=tf.keras.initializers.GlorotUniform(seed=self.config["seed"]),
                    bias_initializer=tf.keras.initializers.Zeros()))
